...
namespace Coffee
{
    ...
    void SceneTreePanel::DrawComponents(Entity entity)
    {
        ...
        if (entity.HasComponent<AnimatorComponent>())
        {
            ...
            {
                const char* UpperAnimName = animatorComponent.GetAnimationController()->GetAnimationClip(animatorComponent.UpperAnimation->CurrentAnimation)->GetAnimationName().c_str();
                const char* LowerAnimName = animatorComponent.GetAnimationController()->GetAnimationClip(animatorComponent.LowerAnimation->CurrentAnimation)->GetAnimationName().c_str();
        ...
        if (ImGui::BeginPopupModal("Add Component..."))
        {
            ...
            std::string items[] = { "Tag Component", "Transform Component", "Mesh Component", "Material Component", "Light Component", "World Environment Component", "Camera Component", "Audio Source Component", "Audio Listener Component", "Audio Zone Component", "Lua Script Component", "Rigidbody Component", "NavMesh Component", "Navigation Agent Component", "UI Empty Component","UI Image Component", "UI Text Component", "UI Toggle Component", "UI Button Component", "UI Slider Component" };
...
/*         if (ShowMaterialOptions)
    ...
    void SceneTreePanel::ShowCreateEntityMenu()
    {
        if (ImGui::BeginPopupModal("Add Entity..."))
        {
            ...
            std::string items[] = {"Empty", "Camera", "Primitive", "Light", "World Environment"};
            static int item_current = 1;
