...
namespace Coffee
{
    struct UISliderComponent : public UIComponent
    {
        ...
        ResourceRef<Texture2D> BackgroundTexture;     ///< The texture of the background.
        ResourceRef<Texture2D> HandleTexture;         ///< The texture of the handle.
        ResourceRef<Texture2D> DisabledHandleTexture; ///< The texture of the disabled handle.
        ResourceID PendingBackgroundTextureID = ResourceID::null;
        ResourceID PendingHandleTextureID = ResourceID::null;
        ResourceID PendingDisabledHandleTextureID = ResourceID::null;
