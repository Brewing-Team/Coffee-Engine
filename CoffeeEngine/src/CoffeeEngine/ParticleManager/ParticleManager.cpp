...
namespace Coffee
{
    ...
    //    particle.Position = glm::vec3(m_Spread.x > Maths::M_EPSILON ? Random32::Rand(-m_Spread.x, m_Spread.x) : 0.0f,
    //                             m_Spread.y > Maths::M_EPSILON ? Random32::Rand(-m_Spread.y, m_Spread.y) : 0.0f,
    //                             m_Spread.z > Maths::M_EPSILON ? Random32::Rand(-m_Spread.z, m_Spread.z) : 0.0f) +
    //                        emitterPosition;
    ...
    //        m_InitialVelocity +
    //        glm::vec3(
    //            m_VelocitySpread.x > Maths::M_EPSILON ? Random32::Rand(-m_VelocitySpread.x, m_VelocitySpread.x) : 0.0f,
    //             m_VelocitySpread.y > Maths::M_EPSILON ? Random32::Rand(-m_VelocitySpread.y, m_VelocitySpread.y) : 0.0f,
    //             m_VelocitySpread.z > Maths::M_EPSILON ? Random32::Rand(-m_VelocitySpread.z, m_VelocitySpread.z)
    //                                                   : 0.0f);
    ...
    //std::array<glm::vec4, 4> ParticleEmitter::GetBlendedAnimatedUVs(float currentLife, int numRows,
    //                                                                float& outBlendAmount)
    //{
    //    // Assumes numRows = numCols
